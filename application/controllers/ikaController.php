    ...
    public function editData()
    {
        ...
        if ($this -> params("x")) {
            ...
            if ($row) {
                ...
                //_ocrResult() di modul ini murni pembaca JSON tanpa penyeragaman bentuk apa
                //pun, jadi dipakai ulang untuk catatan_ocr — kolomnya sama-sama TEXT berisi
                //JSON dan sama-sama boleh kosong.
